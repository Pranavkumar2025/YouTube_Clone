...
const Header = () => {
  ...
  const handleSuggestion = (event) => {
    ...
    navigate(`/results?search_query=${encodeURI(suggestion)}`);
  };
    ...
    <div className="fixed top-0 left-0 right-0 z-50 bg-white">
      <div className="flex flex-row justify-between items-center px-4 py-3">
        <div className="flex flex-row items-center">
          ...
          <a href="/"><img src={youtubeIcon}  className="w-[180px]" alt="" /></a>
        </div>
        ...
        <div className='flex flex-row-reverse justify-around'>
          <div className='w-10 h-10 ml-5 cursor-pointer'>
            <img className='mt-1 rounded-full' alt='user-icon' src={UserIcon} />
          </div>
          <div className='w-10 h-10 hover:rounded-full hover:bg-gray-100 ml-5 cursor-pointer relative'>
            ...
            <div className='absolute text-white w-6 h-5 rounded-2xl border-2 border-white top-[3px] left-5 text-xs text-center'></div>
          </div>
          <div className='w-10 h-10 hover:rounded-full hover:bg-gray-100 ml-5 cursor-pointer'>
